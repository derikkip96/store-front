<div class="uk-card uk-card-default uk-card-hover uk-card-body uk-text-center">
    ...
    <h5><a class="uk-link-heading" href="{{ route('products.show',$category['attributes']['slug']) }}">{{ $category['attributes']['title'] }}</a></h5>
    <a class="uk-button-default uk-button-small uk-border-rounded" href="#">View products</a>
</div>
