<div class="uk-card uk-card-default uk-card-hover uk-card-body uk-text-center">
    ...
    <h5><a class="uk-link-heading" href="{{ route('products.show',$product['attributes']['slug']) }}">{{ $product['attributes']['title'] }}</a></h5>
    <h6>{{ $product['attributes']['price']['currency'] }} {{ $product['attributes']['price']['amount'] }}</h6>
    <button class="uk-button-default uk-button-small uk-border-rounded" type="submit">ADD TO CART</button>
</div>
